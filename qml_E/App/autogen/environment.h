...
Q_IMPORT_QML_PLUGIN(Manipulador_IAPlugin)
Q_IMPORT_QML_PLUGIN(Manipulador_IAContentPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/Manipulador_IAContent/App.qml";
